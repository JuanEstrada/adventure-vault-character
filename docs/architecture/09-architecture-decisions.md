...
| [ADR-008](../adr/ADR-008-use-compendium-and-compendium-import-system-terminology.md) | Compendium and Compendium Import System are the standard terms for imported rules content and XML ingestion. |
